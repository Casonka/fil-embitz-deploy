...
/*!
*    @brief RTC_Alarm_A_Init - initialize Alarm A
*/
...
/*!
*    @brief RTCAlarm_A_ChangeTime - changing alarm time for Alarm A
*    @arg DATE - time date value
*    @arg HOUR - hour data value
*    @arg MINUTE - minute data value
*    @arg SECOND - second data value
*/
...
/*!
*    @brief RTC_Alarm_B_Init - initialize Alarm B
*/
...
/*!
*    @brief RTCAlarm_B_ChangeTime - changing alarm time for Alarm B
*    @arg DATE - time date value
*    @arg HOUR - hour data value
*    @arg MINUTE - minute data value
*    @arg SECOND - second data value
...
/*!
*    @brief RTC_GetStatus - Show timer in string perspective
*        @attention @fixme
*/
...
/*!
*    @brief RTC_GetTime - getting timer values
*/
#define RTC_GetTime         {\
