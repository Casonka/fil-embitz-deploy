...
/*!
*   @brief I2C_MemoryWriteMulriple(I2C_TypeDef* I2Cx, uint8_t address, uint8_t Register, uint8_t* Buffer, uint8_t Length)
*               Write Multiple values to Slave's Register which have address
*   @arg address - Device address
*   @arg Register - Slave's internal register
*   @arg Buffer - buffer values pointer
*   @arg Length - length of transmission (values)
*       @return number of success transmitted values
*/
...
/*!
*   @brief I2CFindDevices(I2C_TypeDef* I2Cx) - Debug function. This function search all devices on bus
*       @arg I2Cx - number of target I2C
